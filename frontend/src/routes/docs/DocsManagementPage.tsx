...
export function DocsManagementPage() {
  return (
    <div className={styles.prose}>
      <h1>管理トークン — 連携ユーザーを管理する</h1>
      <p>
        管理トークンは、あなたのアプリに紐づくユーザー連携だけを扱うためのサーバー側トークンです。
      ...
      <h2>管理トークンの取得</h2>
      <p>
        管理トークンはアプリ登録が承認されると発行されます。
        開発者画面のアプリ申請詳細ページで確認できます（一度しか表示されません）。
      </p>
      <h2>API の使い方</h2>
      <pre><code>{`# 連携ユーザー一覧
